...
public class Operators {
    ...
    private static final List<Operator> mList = Arrays.asList(
        ...
        new Operator(4, R.string.life_ua, R.drawable.life_ua, Country.UKRAINE, "*123*3*38%s#"),
        ...
        new Operator(104, R.string.tele2_ru, R.drawable.tele2_ru, Country.RUSSIA,  "*118*8%s#"),
        ...
        // Belarus
        new Operator(200, R.string.velcom, 0, Country.BELARUS, "*131*%s#"),
        new Operator(201, R.string.mts_by, 0, Country.BELARUS, "*120*%s#"),
        new Operator(202, R.string.life_by, 0, Country.BELARUS,  "*120*2*%s#"),
        // Moldova
        new Operator(300, R.string.idc, 0, Country.MOLDOVA, "887#%s"),
        new Operator(301, R.string.mold_cell, 0, Country.MOLDOVA, "*111*7%s#"),
        // Kazakhstan
        new Operator(400, R.string.kcell, 0, Country.KAZAKHSTAN, "*130*8%s#"),
        new Operator(401, R.string.activ_kz, 0, Country.KAZAKHSTAN, "*130*8%s#"),
        new Operator(402, R.string.beeline_kz, 0, Country.KAZAKHSTAN, "*144*8%s#"),
        new Operator(403, R.string.tele2_kz, 0, Country.KAZAKHSTAN, "*144*8%s#")
    );
